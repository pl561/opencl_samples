...
/*
    ...
    https://stackoverflow.com/questions/7542808/what-is-needed-to-compile-opencl-on-ubuntu-and-by-extension-opencl-period
*/
...
int main() {
    ...
    printf("kernel result = %i", kernel_result);
